...
export default function EBIOSForm({ onResult, initialData, isEdit, readOnly }) {
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mb-6">
      {readOnly && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 text-red-700 font-bold rounded-xl text-sm flex items-center gap-2">
          ⚠️ Mode Lecture Seule : Seuls les propriétaires ou contributeurs peuvent modifier ce projet.
        </div>
      )}
      ...
      <fieldset disabled={readOnly} className="border-0 p-0 m-0 space-y-4">
               ...
               <div key={i} className="border border-gray-200 p-4 rounded-xl bg-gray-50 mb-4 space-y-3 relative group hover:shadow-md transition">
                  ...
                  <div className="flex flex-wrap gap-6 items-center pt-2 border-t border-gray-200">
                    <div className="flex flex-col">
                      <label className="text-sm text-gray-650 font-bold mb-1">Vraisemblance (1-4):</label>
                    ...
                    <div className="flex flex-col">
                      <label className="text-sm text-gray-650 font-bold mb-1">Gravité (1-4):</label>
            ...
            {treatments.map((t, i) => {
              ...
              return (
                <div key={i} className="border border-gray-200 p-4 rounded-xl bg-gray-50 mb-4 space-y-3 relative group hover:shadow-md transition">
                    ...
                    <div className="flex flex-wrap gap-6 items-center pt-2 border-t border-gray-200">
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-650 font-bold mb-1">Difficulté (Coût/Effort):</label>
                      ...
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-650 font-bold mb-1">Vraisemblance Résiduelle:</label>
                      ...
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-650 font-bold mb-1">Gravité Résiduelle:</label>
